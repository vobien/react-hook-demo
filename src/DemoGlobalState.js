...
function DemoGlobalState() {
  ...
  return (
    <div>
      ...
      <p>Redux is the best choice for global state </p>
      <ul>
        <li>
          performance, context & useReducer will render all children when state
          changes
        </li>
        <li>
        ...
        <li>
          Redux can add many middleware such as logger, with context we have to
          manually implement middleware
        </li>
      </ul>
